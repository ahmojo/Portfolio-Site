    ...
    de: {
      ...
      github: {
        ...
        metrics: {
          ...
          trackedTotalLabel: 'Erfasste Klone',
          trackedTotalTitle: 'Kumulativ erfasste Klonvorgänge',
          uniqueClonersLabel: 'Quellen · 14T',
          uniqueClonersTitle: 'Eindeutige Klon-Quellen · 14 Tage',
          clones14dLabel: 'Klone · 14T',
          clones14dTitle: 'Klonvorgänge · 14 Tage',
          rollingWindow: 'rollierend',
          ...
          helpUnique: 'Eindeutige Klon-Quellen und ihre Veränderung gelten nur für das rollierende 14-Tage-Fenster.',
        },
      },
      learning: {
    ...
    en: {
      ...
      github: {
        ...
        metrics: {
          ...
          trackedTotalLabel: 'Tracked clones',
          trackedTotalTitle: 'Cumulatively tracked clone operations',
          uniqueClonersLabel: 'Sources · 14d',
          uniqueClonersTitle: 'Unique clone sources · 14 days',
          clones14dLabel: 'Clones · 14d',
          clones14dTitle: 'Clone operations · 14 days',
          ...
          helpUnique: 'Unique clone sources and their change apply only to the rolling 14-day window.',
        },
      },
      learning: {
