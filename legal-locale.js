...
(function(){
  ...
  const PRIVACY = [
    ...
    entry('section:nth-of-type(7) p:nth-of-type(1)', 'Am Ende der Startseite kann freiwillig eine positive oder negative Bewertung abgegeben werden. Optional kann ein Kommentar mit maximal 1\'000 Zeichen ergänzt und ausgewählt werden, wo das Portfolio entdeckt wurde. Gespeichert werden nur die Bewertung, die freiwillige Herkunftsauswahl, der Kommentar als reiner Text und der Zeitpunkt der Einsendung in UTC.', 'At the end of the home page, visitors can optionally submit a positive or negative rating. An optional comment of up to 1,000 characters can be added, along with where the portfolio was discovered. Only the rating, the optional discovery source, the comment as plain text and the submission time in UTC are stored.'),
